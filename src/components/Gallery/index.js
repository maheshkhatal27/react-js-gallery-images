...
class Gallery extends Component {
  ...
  getCurrentImage = () => {
    ...
    const filteredImages = imagesList.filter(
      eachImageObj => eachImageObj.id === activeImageId,
    )
  ...
  render() {
    ...
    const filteredImages = this.getCurrentImage()
      ...
      <div className="image-container">
        <div className="img-content">
          <img
            ...
            alt={filteredImages[0].imageAltText}
          />
        ...
        <ul className="img-thumbnail-container">
          {imagesList.map(eachImgDetails => (
            <ThumbnailItem
              ...
              isActive={eachImgDetails.id === activeImageId}
            />
          ))}
        </ul>
      </div>
